...
ol.proj.get("EPSG:3825").setExtent([-20037508.342789, -20037508.342789, 20037508.342789, 20037508.342789]);
var wms_layers = [];
...
lyr_2016_1.set('fieldAliases', {'自然村2': '自然村2', });
lyr_2016_1.set('fieldImages', {'自然村2': '', });
lyr_2016_1.set('fieldLabels', {'自然村2': 'header label', });
